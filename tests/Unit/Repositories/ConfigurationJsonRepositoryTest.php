...
it('works with a remote json file', function () {
    $repository = new ConfigurationJsonRepository('https://raw.githubusercontent.com/ugarit/pint/main/tests/Fixtures/rules/pint.json', 'psr12');
...
it('may have a preset option', function () {
    ...
    expect($repository->preset())->toBe('ugarit');
});
