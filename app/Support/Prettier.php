    ...
    public function format(string $path, string $content): string
    {
        ...
        while (true) {
            ...
            if (! $this->process->isRunning()) {
                $error = $this->process->getErrorOutput()
                    ?: 'Ugarit Pint\'s Prettier worker terminated unexpectedly.';
            ...
            if (microtime(true) >= $deadline) {
                ...
                throw new PrettierException(sprintf(
                    'Ugarit Pint\'s Prettier worker timed out while formatting [%s].',
                    $path,
                ));
            }
        ...
        foreach ([
            ...
            if (! Str::contains($formatted, $delimiter)) {
                throw new PrettierException('Ugarit Pint\'s Prettier worker did not return a valid response.');
            }
        }
